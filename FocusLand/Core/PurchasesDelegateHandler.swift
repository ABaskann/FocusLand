...
func purchases(_ purchases: Purchases, receivedUpdated customerInfo: CustomerInfo) {/// - Update our published customerInfo object
 UserViewModel.shared.customerInfo = customerInfo}

    /*
     
Note: this can be tested by opening a link like:
   itms-services://?action=purchaseIntent&bundleId=<BUNDLEID>&productIdentifier=<SKPRODUCT_ID>
   */
  func purchases( purchases: Purchases,
